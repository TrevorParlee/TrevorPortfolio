      ...
      <div className="container mx-auto flex justify-between">
        <nav className="flex">
          <NavLink
            ...
            hover:text-green-800 text-6xl font-bold cursive tracking-widest"
          >
            Trevor Parlee
          </NavLink>
          <NavLink
            to="/post"
            className="inline-flex text-3xl items-center py-3 px-3 my-6 rounded text-red-200 hover:text-green-800"
